...
const Colors = (function() {
    ...
    const SWATCH_STORAGE_KEY = 'ai_meas_color_swatches';
    ...
    function init() {
        // Load swatches from storage or use defaults
    ...
    function applyCMYK(s) {
        ...
        // Dispatch change event to trigger redraw
        ...
        swatchElements.forEach(el => {
            el.addEventListener('click', (e) => {
                ...
                if (isSaveMode) {
                    ...
                    Storage.set(SWATCH_STORAGE_KEY, swatches);
                    renderSwatches();
                    // Optional: Uncheck save mode after saving
